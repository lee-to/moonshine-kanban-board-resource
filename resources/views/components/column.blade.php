...
<div class="flex-shrink-0 select-none" style="max-width: 450px;">
    <div class="bg-slate-100 dark:bg-dark-800 rounded-lg shadow-sm flex flex-col h-full">
        ...
        {{-- Header ---}}
        <div class="px-4 py-3 border-b border-gray-200 dark:border-dark-700 flex items-center justify-between">
        ...
        <div
            ...
            data-parent_key="{{ $key }}"
            class="flex flex-col gap-3 p-3 overflow-y-auto min-h-[150px] max-h-[calc(100vh-250px)]"
        >
